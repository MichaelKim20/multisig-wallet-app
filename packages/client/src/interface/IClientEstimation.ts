...
export interface IClientEstimationMethods {
    create: (name: string, description: string, owners: string[], required: number) => Promise<GasFeeEstimation>;
    changeName: (wallet: string, name: string) => Promise<GasFeeEstimation>;
    changeDescription: (wallet: string, description: string) => Promise<GasFeeEstimation>;
    submitTransaction: (
