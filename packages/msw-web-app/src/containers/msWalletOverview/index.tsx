      ...
      <div className="tablet:flex items-end tablet:space-x-6">
        <div className="w-full">
          <h1 className="font-bold text-ui-800 ft-text-3xl">
            {t('createMSWallet.overview.title')}
          </h1>
          <p className="mt-2 text-ui-600 ft-text-lg">
            {t('createMSWallet.overview.description')}
          </p>
        </div>
        ...
        /> */}
          <ButtonText
            ...
            label={t('createMSWallet.overview.button')}
...
const OverviewCards = [
  <CardWithImage
    ...
    caption={i18n.t('createMSWallet.step1.label')}
    title={i18n.t('createMSWallet.step1.title')}
  />,
  <CardWithImage
    key="DefineMetadata"
    imgSrc={<IlluObject object="labels" />}
    caption={i18n.t('createMSWallet.step2.label')}
    title={i18n.t('createMSWallet.step2.title')}
  />,
  <CardWithImage
    key="SetupCommunity"
    imgSrc={<IlluObject object="users" />}
    caption={i18n.t('createMSWallet.step3.label')}
    title={i18n.t('createMSWallet.step3.title')}
  />,
  <CardWithImage
    key="ConfigureGovernance"
    imgSrc={<IlluObject object="settings" />}
    caption={i18n.t('createMSWallet.step4.label')}
    title={i18n.t('createMSWallet.step4.shortTitle')}
  />,
];
