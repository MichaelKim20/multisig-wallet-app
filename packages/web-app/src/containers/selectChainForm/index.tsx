...
const networks: SelectableNetworks = {
  main: {
    cost: ['BOSagora mainnet', 'ethereum'],
    // cost: ['polygon', 'arbitrum', 'ethereum'],
    popularity: ['BOSagora mainnet', 'ethereum'],
    security: ['ethereum', 'BOSagora mainnet'],
  },
  test: {
    cost: ['BOSagora devnet', 'sepolia'],
    popularity: ['BOSagora devnet', 'goerli'],
    security: ['goerli', 'BOSagora devnet'],
  },
};
