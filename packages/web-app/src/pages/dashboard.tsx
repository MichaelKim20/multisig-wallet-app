  ...
  if (liveWallet && liveAddress) {
    return (
      <>
        ...
        {/*{isDesktop ? (*/}
        <DashboardContent walletAddress={liveAddress} />
        {/*) : (*/}
...
const DashboardContent: React.FC<DashboardContentProps> = ({walletAddress}) => {
  return (
    <>
      <LeftWideContent></LeftWideContent>
      <RightNarrowContent>
        {/*<TreasurySnapshot daoAddressOrEns={walletAddress} />*/}
        {/*<MembershipSnapshot daoAddressOrEns={walletAddress} />*/}
      </RightNarrowContent>
    </>
  );
};
