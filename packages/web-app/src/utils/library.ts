...
export const translateToAppNetwork = (
  ...
  switch (sdkNetwork.name) {
    ...
    case 'bosagora_mainnet':
      return 'BOSagora mainnet';
    case 'bosagora_testnet':
      return 'BOSagora testnet';
    case 'bosagora_devnet':
      return 'BOSagora devnet';
    case 'localhost':
      return 'localhost';
  }
  return 'unsupported';
